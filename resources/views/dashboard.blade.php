...
<body class="bg-gradient-to-br from-emerald-50 via-teal-50 to-green-100 min-h-screen">
  ...
  <nav class="flex justify-between items-center py-6 px-10 bg-white/80 backdrop-blur-md shadow-sm fixed w-full top-0 z-50">
    <a href="/landingpage" class="text-3xl font-bold text-emerald-600 tracking-wide">Healya</a>
    ...
    <div class="flex items-center gap-8">
      ...
      <div class="relative group">
        <button class="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-cyan-500 text-white px-5 py-2 rounded-xl hover:opacity-90 transition">
          <span id="username">Halo, Bitari</span>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.94l3.71-3.71a.75.75 0 111.06 1.06l-4.24 4.24a.75.75 0 01-1.06 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
          </svg>
        </button>
        <div class="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition duration-200">
          <a href="/landingpage" class="block px-4 py-2 text-red-600 hover:bg-red-50">Keluar</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <main class="pt-32 pb-20 px-6 md:px-20">
    ...
    <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-3xl p-10 text-center mb-16">
      ...
      <p class="text-gray-600 mb-8">Kelola jadwal dan riwayat pemeriksaan Anda dengan mudah melalui dashboard Healya.</p>
      <a href="/booking" class="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-xl font-semibold transition">Booking Pemeriksaan</a>
    </div>
  ...
  <footer class="text-center text-gray-500 py-10 text-sm border-t mt-20">
    © 2025 Healya. Semua Hak Dilindungi.
  </footer>
